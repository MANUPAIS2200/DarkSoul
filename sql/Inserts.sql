...
INSERT INTO Categorias (Descripcion) VALUES
('Gele, Lubircantes y `más')
INSERT INTO Categorias (Descripcion) VALUES
('Lenceria')

INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Vibradores')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Anal')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Arnéses y Prótesis')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Bolas Chinas')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Clítoris y Punto G')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Consoladores / Dildos')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Doble Penetración')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Extensores /Potenciadores')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Fetiche /Bondage')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Masturbadores')
...
(1, 'Muñecas / Muñecos')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(1, 'Chascos y Dibersión')

INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(2, 'Afrodisíaco')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(2, 'Aceites y Esencias')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(2, 'Geles y Lubricantes')
INSERT INTO SubCategorias(IDCategoria, Descripcion) VALUES
(2, 'Preservativos')
...
INSERT INTO Producto(Nombre,IDCategoria, IDSubCategoria,Precio, Stock, Descripcion,Marca) VALUES
('Satisfyer Double Classic', 1,1,1,1,'Un placer aún más intenso durante el juego amoroso gracias a la estimulación simultánea. Las excitantes vibraciones también se transmiten al lado más fino, el que se introduce en la vagina. Esto no solo provoca en tu chico una excitante sensación de estrechez, sino que también le transmite "buenas vibraciones", algo que su pene también agradecerá. Y mucho. Al ser resistente al agua, también podrás disfrutar de los placeres de este juguete en la ducha. 

Características:

Vibrador para parejas
Estimulo clítoris y Punto G
Motor potente y silencioso
10 programas de vibración
Apto uso durante penetración
Recargable USB (Cable magnético)
Silicona grado medicinal
Impermeable IPX7
Peso: 52 gr
Premio de diseño 2017
Seguro al cuerpo
Libre de Ftalatos
Medidas:
...
INSERT INTO Imagenes (IDProducto, Descripcion) VALUES(1, 'prueba')
